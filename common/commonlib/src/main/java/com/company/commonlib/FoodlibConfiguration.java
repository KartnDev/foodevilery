...
@PropertySource(name = "com.company.commonlib", value = "classpath:/com/company/commonlib/module.properties")
public class FoodlibConfiguration {

    @Bean("foodlib_FoodlibViewControllers")
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.company.commonlib"));
        return viewControllers;
    }

    @Bean("foodlib_FoodlibActions")
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("com.company.commonlib"));
        return actions;
    }
}
